...
7. Нажмите на **"Console"** сверху в панели. В консоль внизу страницы вставьте скопированный код и нажмите **Enter**. (если выдают ошибку Warning...., то напишите "разрешить вставку" или "allow pasting")
